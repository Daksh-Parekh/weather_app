...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0XFF141414),
        title: hWatch.bookMark.isNotEmpty || hWatch.searchedCity != null
            ? Row(
                children: [
                  const Icon(
        ...
        actions: [
          hWatch.bookMark.isNotEmpty || hWatch.searchedCity != null
              ? IconButton(
                  onPressed: () {
      ...
      body: hWatch.bookMark.isNotEmpty || hWatch.searchedCity != null
          // ? PageView.builder(
          ...
          // itemC/ount: 0,
          // itemBuilder: (context, index) {
          // img = hWatch.bookMark[index].weathers![index].main;
          Padding(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          "${hWatch.weatherModel?.weathers?.firstOrNull!.description}",
                          style: const TextStyle(color: Colors.white),
                        )
                      ],
                    ),
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  10.w,
                                  Text(
                                    "${DateTime.fromMicrosecondsSinceEpoch((hWatch.weatherModel?.sys?.sunrise ?? 0) * 1000).hour} : ${DateTime.fromMicrosecondsSinceEpoch((hWatch.weatherModel?.sys?.sunrise ?? 0) * 1000).minute} am",
                                    style: const TextStyle(
                                      fontSize: 17,
                                      color: Colors.white,
                                      fontWeight: FontWeight.bold,
